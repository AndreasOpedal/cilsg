...
class SGDweighted(AlgoBase):
    ...
    def __init__(self, n_factors=100, n_epochs=20, init_mean=0, init_std=0.1, alpha_pu=0.1, alpha_qi=0.1, reg_pu=0.5, reg_qi=0.5, lambda_bu=1, lambda_bi=1, low=1, high=5, conf=None, verbose=False):
        '''
