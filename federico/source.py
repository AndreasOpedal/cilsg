...
instances['SGDheu'][33] = SGDheu(n_factors=162, n_epochs=85, init_mean=0.2, init_std=0.005, lr_pu=0.015, lr_qi=0.015, decay_pu=0.05, decay_qi=0.05, reg_pu=0.075, reg_qi=0.075, lambda_bu=25, lambda_bi=1, conf=0.49)
